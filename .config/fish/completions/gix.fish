...
complete -c gix -n "__fish_gix_needs_command" -f -a "branch" -d 'Interact with branches'
complete -c gix -n "__fish_gix_needs_command" -f -a "branches" -d 'Interact with branches'
...
complete -c gix -n "__fish_gix_using_subcommand branch; and not __fish_seen_subcommand_from list help" -s h -l help -d 'Print help'
complete -c gix -n "__fish_gix_using_subcommand branch; and not __fish_seen_subcommand_from list help" -f -a "list" -d 'List branches'
complete -c gix -n "__fish_gix_using_subcommand branch; and not __fish_seen_subcommand_from list help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c gix -n "__fish_gix_using_subcommand branch; and __fish_seen_subcommand_from list" -s a -l all -d 'List remote-tracking as well as local branches'
complete -c gix -n "__fish_gix_using_subcommand branch; and __fish_seen_subcommand_from list" -s h -l help -d 'Print help'
complete -c gix -n "__fish_gix_using_subcommand branch; and __fish_seen_subcommand_from help" -f -a "list" -d 'List branches'
complete -c gix -n "__fish_gix_using_subcommand branch; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c gix -n "__fish_gix_using_subcommand branches; and not __fish_seen_subcommand_from list help" -s h -l help -d 'Print help'
complete -c gix -n "__fish_gix_using_subcommand branches; and not __fish_seen_subcommand_from list help" -f -a "list" -d 'List branches'
complete -c gix -n "__fish_gix_using_subcommand branches; and not __fish_seen_subcommand_from list help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c gix -n "__fish_gix_using_subcommand branches; and __fish_seen_subcommand_from list" -s a -l all -d 'List remote-tracking as well as local branches'
complete -c gix -n "__fish_gix_using_subcommand branches; and __fish_seen_subcommand_from list" -s h -l help -d 'Print help'
complete -c gix -n "__fish_gix_using_subcommand branches; and __fish_seen_subcommand_from help" -f -a "list" -d 'List branches'
complete -c gix -n "__fish_gix_using_subcommand branches; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c gix -n "__fish_gix_using_subcommand commit; and not __fish_seen_subcommand_from verify sign describe help" -s h -l help -d 'Print help'
complete -c gix -n "__fish_gix_using_subcommand commit; and not __fish_seen_subcommand_from verify sign describe help" -f -a "verify" -d 'Verify the signature of a commit'
complete -c gix -n "__fish_gix_using_subcommand commit; and not __fish_seen_subcommand_from verify sign describe help" -f -a "sign" -d 'Sign a commit and print the signed commit\'s id to stdout'
complete -c gix -n "__fish_gix_using_subcommand commit; and not __fish_seen_subcommand_from verify sign describe help" -f -a "describe" -d 'Describe the current commit or the given one using the name of the closest annotated tag in its ancestry'
complete -c gix -n "__fish_gix_using_subcommand commit; and not __fish_seen_subcommand_from verify sign describe help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c gix -n "__fish_gix_using_subcommand commit; and __fish_seen_subcommand_from verify" -s h -l help -d 'Print help'
complete -c gix -n "__fish_gix_using_subcommand commit; and __fish_seen_subcommand_from sign" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c gix -n "__fish_gix_using_subcommand commit; and __fish_seen_subcommand_from help" -f -a "sign" -d 'Sign a commit and print the signed commit\'s id to stdout'
...
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "archive" -d 'Subcommands for creating worktree archives'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "branch" -d 'Interact with branches'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "clean" -d 'Remove untracked files from the working tree'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "commit-graph" -d 'Subcommands for interacting with commit-graph files'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "odb" -d 'Interact with the object database'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "fsck" -d 'Check for missing objects'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "tree" -d 'Interact with tree objects'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "commit" -d 'Interact with commit objects'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "tag" -d 'Interact with tag objects'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "verify" -d 'Verify the integrity of the entire repository'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "revision" -d 'Query and obtain information about revisions'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "credential" -d 'A program just like `git credential`'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "fetch" -d 'Fetch data from remotes and store it in the repository'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "clone" -d 'Clone a repository into a new directory'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "mailmap" -d 'Interact with the mailmap'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "remote" -d 'Interact with the remote hosts'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "attributes" -d 'Interact with the attribute files like .gitattributes'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "exclude" -d 'Interact with the exclude files like .gitignore'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "index" -d 'Interact with a worktree index like .git/index'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "submodule" -d 'Interact with submodules'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "cat" -d 'Show whatever object is at the given spec'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "is-clean" -d 'Check for changes in the repository, treating this as an error'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "is-changed" -d 'Check for changes in the repository, treating their absence as an error'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "config-tree" -d 'Show which git configuration values are used or planned'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "status" -d 'Compute repository status similar to `git status`'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "config" -d 'Print all entries in a configuration file or access other sub-commands'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "corpus" -d 'Run algorithms on a corpus of git repositories and store their results for later analysis'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "merge-base" -d 'A command for calculating all merge-bases'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "merge" -d 'Perform merges of various kinds'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "env" -d 'Print paths relevant to the Git installation'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "diff" -d 'Print all changes between two objects'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "log" -d 'List all commits in a repository, optionally limited to those that change a given path'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "worktree" -d 'Commands for handling worktrees'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "free" -d 'Subcommands that need no Git repository to run'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "blame" -d 'Blame lines in a file'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "completions" -d 'Generate shell completions to stdout or a directory'
complete -c gix -n "__fish_gix_using_subcommand help; and not __fish_seen_subcommand_from archive branch clean commit-graph odb fsck tree commit tag verify revision credential fetch clone mailmap remote attributes exclude index submodule cat is-clean is-changed config-tree status config corpus merge-base merge env diff log worktree free blame completions help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c gix -n "__fish_gix_using_subcommand help; and __fish_seen_subcommand_from branch" -f -a "list" -d 'List branches'
...
complete -c gix -n "__fish_gix_using_subcommand help; and __fish_seen_subcommand_from commit" -f -a "sign" -d 'Sign a commit and print the signed commit\'s id to stdout'
