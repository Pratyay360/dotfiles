...
'-h[Print help (see more with '\''--help'\'')]' \
'--help[Print help (see more with '\''--help'\'')]' \
'*::names -- Bookmark names to track:_default' \
&& ret=0
;;
(t)
_arguments "${_arguments_options[@]}" : \
...
'-h[Print help (see more with '\''--help'\'')]' \
'--help[Print help (see more with '\''--help'\'')]' \
'*::names -- Bookmark names to untrack:_default' \
&& ret=0
;;
        esac
    ;;
...
'*--config=[Additional configuration options (can be repeated)]:NAME=VALUE:_default' \
'*--config-file=[Additional configuration files (can be repeated)]:PATH:_files' \
'(--user --repo --workspace)--include-defaults[Whether to explicitly include built-in default values in the list]' \
...
'(--edit --editor)--no-edit[Don'\''t open an editor]' \
'--editor[Open an editor to edit the change description]' \
'(--editor)--edit[Open an editor to edit the change description]' \
...
&& ret=0
    ...
    (colocation)
        words=($line[1] "${words[@]}")
        (( CURRENT += 1 ))
        curcontext="${curcontext%:*:*}:jj-git-colocation-command-$line[1]:"
        case $line[1] in
            (disable)
_arguments "${_arguments_options[@]}" : \
'-R+[Path to repository to operate on]:REPOSITORY:_files -/' \
...
'*--config=[Additional configuration options (can be repeated)]:NAME=VALUE:_default' \
'*--config-file=[Additional configuration files (can be repeated)]:PATH:_files' \
'(-b --branch -t --tag)--tracked[Fetch only tracked bookmarks]' \
...
'*--revision=[Push bookmarks pointing to these commits (can be repeated)]:REVSETS:_default' \
...
'(-b --bookmark -t --tag -r --revision -c --change --named)--deleted[Push all deleted bookmarks]' \
...
'-h[Print help (see more with '\''--help'\'')]' \
'--help[Print help (see more with '\''--help'\'')]' \
'::revision_pos -- Show changes in this revision, compared to its parent(s) \[default\: @\] \[aliases\: -r\]:_default' \
&& ret=0
;;
(sign)
_arguments "${_arguments_options[@]}" : \
...
'-h[Print help (see more with '\''--help'\'')]' \
'--help[Print help (see more with '\''--help'\'')]' \
'*::names -- Tag names to delete:_default' \
&& ret=0
;;
(d)
_arguments "${_arguments_options[@]}" : \
...
(set)
_arguments "${_arguments_options[@]}" : \
'-r+[Target revision to point to]:REVSET:_default' \
'--revision=[Target revision to point to]:REVSET:_default' \
'--to=[Target revision to point to]:REVSET:_default' \
'-R+[Path to repository to operate on]:REPOSITORY:_files -/' \
'--repository=[Path to repository to operate on]:REPOSITORY:_files -/' \
'--at-operation=[Operation to load the repo at]:AT_OPERATION:_default' \
'--at-op=[Operation to load the repo at]:AT_OPERATION:_default' \
